...
function update() {
  ...
  if (ball.x + ball.radius >= canvas.width) {
    ...
    user.score += 1;
    document.getElementById('MessageLabel').innerHTML = "User Scored a point!";
    reset(); 
  }


  if (user.score >= 20) {
    document.getElementById('MessageLabel').innerHTML = "User wins!";
    return;
  }
  ...
  if (ball.x - ball.radius <= 0) {
    ...
    ai.score += 1;
    document.getElementById('MessageLabel').innerHTML = "AI Scored a point!";
    reset()
  }
  ...
  if (ai.score >= 20) {
    document.getElementById('MessageLabel').innerHTML = "AI wins!";
    return;
  }
